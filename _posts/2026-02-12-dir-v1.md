...
Traditional service discovery systems weren't designed for the agentic AI ecosystem. They lack semantic understanding of agent capabilities, don't support feature-based discovery, and can't handle the rich metadata that describes what agents can do. Developer platforms often resort to centralized marketplaces or proprietary directories, fragmenting the ecosystem and limiting agent reusability.
...
[DIR (Directory)](https://docs.agntcy.org/dir/overview/) was built to solve exactly these challenges, providing a distributed, capability-aware directory service purpose-built for the agentic AI ecosystem.
...
- **Hierarchical Taxonomies** - Capabilities organized through semantic taxonomies for efficient matching
...
```
Query: "agents with natural language processing skills"
  ↓
...
If you're interested in publishing your own agents, running a full DIR node, or being part of the public DIR network, you can check out the [github.com/agntcy/dir-staging](https://github.com/agntcy/dir-staging) repository for instructions on how to get started.

### Documentation & Community

DIR is open source and welcomes contributions. Check out the documentation to get started:
...
- [Getting Started](https://docs.agntcy.org/dir/getting-started/)

You can find comprehensive documentation for:

- [CLI usage](https://docs.agntcy.org/dir/directory-cli/)
- [MCP server](https://github.com/agntcy/dir/tree/main/mcp/)
- [SDK integration](https://docs.agntcy.org/dir/directory-sdk/)
