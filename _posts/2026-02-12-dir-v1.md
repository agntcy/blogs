...
| MCP Server | `dirctl mcp serve` | dirctl | [Directory MCP Server Blog Post](https://blogs.agntcy.org/technical/2026/02/12/directory-mcp-server.html) <br> [MCP Integration Documentation](https://docs.agntcy.org/dir/mcp/) |
