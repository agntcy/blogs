---
layout: post
title: "Crossing Enterprise Boundaries with SLIM: A Dell and Cisco Co-Innovation"
date: 2026-09-11 09:00:00 +0000
author: Trevor Conn
author_url: https://github.com/tsconn23
categories: technical
tags: [slim, mls, spiffe, spire, a2a, mcp, kubernetes, multi-cluster]
mermaid: true
---

Dell’s application of SLIM to a customer use case facilitating agentic interaction across enterprise boundaries.
...
sequenceDiagram
    ...
    User->>GW: Request
    GW->>REG: Lookup agent cards, skills, and slim_topics
